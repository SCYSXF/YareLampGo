...
- [GitHub 网页版图文组装说明](../hardware/v2/YareLampGo_V2.0_assembly_manual.md)
- [原始图文组装 DOCX 下载](../hardware/v2/YareLampGo_V2.0_assembly_manual.docx)
...
按 [V2.0 硬件与组装](../hardware/v2/README.md) 和 [GitHub 网页版组装说明](../hardware/v2/YareLampGo_V2.0_assembly_manual.md) 完成机械结构。全程断开 12V 和 USB，重点检查：
